...
/// <summary>
/// Will be moved into CCL for A13
///    - Fluffy
/// </summary>
namespace Combat_Realism
{
    public class Utility_UI
    {
        ...
        public static void DoThingFilterConfigWindow( Rect canvas, ref Vector2 scrollPosition, ref float viewHeight, ThingFilter filter,
                                                   ...
                                                   bool buttonsAtBottom = false )
        {
            ...
            float labelWidth = width - Widgets.CheckboxSize - 6f;
